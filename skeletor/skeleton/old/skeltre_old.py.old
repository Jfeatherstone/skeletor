...
if __name__ == "__main__":
    ...
    nboxes = 1000 #Number of boxes in which to divide the bounding box of the given set of points
    ...
    points = np.load("../Data/2d_web_scan.npy")
    ...
    name_file ="%s_N%sK_%s.pkl"%(save_name, str(nboxes)[0:2], 'pre_reduction' )
    ...
    for t in ts:
        ...
        t0 = time.perf_counter()
        print([myDict[d].connections for d in myDict])
